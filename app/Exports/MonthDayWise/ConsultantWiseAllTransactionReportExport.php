...
class ConsultantWiseAllTransactionReportExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    public function headings(): array
    {
        ...
        switch ($this->type) {
            ...
            case 'consultations':
                $fields = ["Sr. No.", "Doctor Name", "Day", "Count", "Total Amount", "Discount Amount"];
                break;
    ...
    public function map($consultant_wise_report): array
    {
        ...
        switch ($this->type) {
            ...
            case 'consultations':
                ...
                $row[] = $consultant_wise_report?->discount_amount;
                break;
