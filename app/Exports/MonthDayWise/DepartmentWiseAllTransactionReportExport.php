...
class DepartmentWiseAllTransactionReportExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    public function headings(): array
    {
        ...
        switch ($this->type) {
            ...
            case 'consultations':
                $fields = ["Sr. No.", "Department Name", "Day", "Count", "Total Amount", "Discount Amount"];
                break;
    ...
    public function map($department_wise_report): array
    {
        ...
        switch ($this->type) {
            ...
            case 'consultations':
                ...
                $row[] = $department_wise_report?->discount_amount;
                break;
