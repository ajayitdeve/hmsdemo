...
{
    public $department_id, $service_group_id, $parameter_unit_id, $code, $name, $short_name, $method, $display_type = 'S', $text_size = 'S', $normal_range = 0, $antibiotic_needed = 0, $is_active = 1, $uom_unit = 0, $multiple_values = 0, $multiple_value_json;
    ...
    public function mount()
    {
        ...
        $this->parameters = Parameter::latest()->get();
    ...
    public function edit(int $parameter_id)
    {
        ...
        if ($parameter) {
            ...
            $this->multiple_values = $parameter->multiple_value;
    ...
    {
        Parameter::find($this->parameter_id)->delete();
    ...
    {
        return view('livewire.pathology.parameter.parameter-master')->extends('layouts.admin')->section('content');
    }
}
