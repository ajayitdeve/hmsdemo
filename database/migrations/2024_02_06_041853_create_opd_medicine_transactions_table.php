...
return new class extends Migration
{
    ...
    {
        Schema::create('opd_medicine_transactions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('return_by_id')->nullable()->default(null)->constrained('users')->onDelete('cascade')->onUpdate('cascade');
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('opd_medicine_transactions');
    }
};
