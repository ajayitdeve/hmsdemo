...
return new class extends Migration
{
    ...
    {
        Schema::create('ip_pharmacy_dues', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(\App\Models\StockPoint::class)->constrained();
            $table->foreignIdFor(\App\Models\Patient::class)->constrained();
            $table->foreignIdFor(\App\Models\Ipd\Ipd::class)->constrained();
            $table->foreignIdFor(\App\Models\IpPharmacyIndentBilling::class)->constrained();
    ...
    {
        Schema::dropIfExists('ip_pharmacy_dues');
    }
};
