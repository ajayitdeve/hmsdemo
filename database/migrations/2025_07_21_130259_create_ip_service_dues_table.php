...
return new class extends Migration
{
    ...
    {
        Schema::create('ip_service_dues', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(\App\Models\Patient::class)->constrained();
            $table->foreignIdFor(\App\Models\Ipd\Ipd::class)->constrained();
            $table->foreignIdFor(\App\Models\IpServiceBilling::class)->constrained();
    ...
    {
        Schema::dropIfExists('ip_service_dues');
    }
};
