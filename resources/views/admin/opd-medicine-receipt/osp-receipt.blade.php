        ...
        <div class="body">
            ...
            <div class="body2">
                ...
                <div class="body-3">
                    ...
                    <p>{{$outSidePatient->registration_no}}</p>
                    <p>{{date('d-M-Y h:i:s A', strtotime($opdMedicineReceipt->created_at))}}</p>
                    <p>{{$outSidePatient->name}}</p>

                    <p>{{$outSidePatient->address}} </p>
                </div>
                <div class="body-4">
                    <p>Bill Date</p>
                    <p></p>
                ...
                <tr>
                    ...
                    <td class="cgst">
                        ...
                        <div class="table-style-2">
                            ...
                            <div>{{$opdmedicinetransactions->taxable_amount * $opdmedicinetransactions->cgst /100 }}</div>
                            <div>{{$opdmedicinetransactions->sgst}}</div>
                            <div>{{$opdmedicinetransactions->taxable_amount * $opdmedicinetransactions->sgst /100 }}</div>
                        </div>

                    </td>
                    <td>{{($opdmedicinetransactions->taxable_amount)+($opdmedicinetransactions->taxable_amount * $opdmedicinetransactions->cgst /100) + ($opdmedicinetransactions->taxable_amount * $opdmedicinetransactions->sgst /100 )}}</td>
                </tr>
                @endforeach
    ...
    <div class="container">
        <div class="vertical-center">
            <button class="print-button" onClick="window.print()">
                ...
                src="{{ asset('assets/img/print.png') }}" />
            </button>`
        </div>
      </div>
</body>
