...
<body>
    @include('partials.back-print-btn', [
        'back_url' => route('admin.ipd.diagnostic-result-list'),
        'width' => '80%',
    ])
    ...
    <table width="80%" align="center">
        ...
        @if ($diagnosticResult->out_side_patient_id == null)
            ...
            <tr>
                ...
                <td width="40%">
                    {{ $diagnosticResult->ip_service_billing->code }}/{{ $diagnosticResult->patient->registration_no }}
                </td>
                <td width="5%"></td>
                <td width="15%">Referred By:</td>
                <td width="30%"> {{ $diagnosticResult->doctor->name }}
                    {{ $diagnosticResult->doctor->qualification }} </td>
            <tr>
            <tr>
                <td width="15%">Bil Dt:</td>
                <td width="40%">{{ $diagnosticResult->ip_service_billing->created_at }}</td>
                <td width="5%"></td>
            ...
            <tr>
                ...
                <td width="30%">{{ $diagnosticResult->ip_service_billing->code }} </td>
            <tr>
        @endif
        <!-- for registered patient  -->
