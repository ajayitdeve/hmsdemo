...
<head>
    <title>IP Service Bill - Receipt</title>
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
</head>

<body bgcolor="#FFFFFF" text="#000000">
    @include('partials.back-print-btn', [
        'back_url' => route('admin.front-desk.adt.ip-service.list'),
        'width' => '90%',
    ])
    ...
    <table width="90%" border="1" cellspacing="0" cellpadding="0" bordercolor="#000000" align="center" height="498">
                        ...
                        <tr>
                            <td height="47" width="54%">
                                <font size="2" face="Arial, Helvetica, sans-serif">Pt
                                    Name
                                    :{{ $ip_service_billing->patient->salution->name }}{{ $ip_service_billing->patient->name }}<br>
                                    <br>
                                    Bill No &nbsp;&nbsp;&nbsp;: {{ $ip_service_billing->code }}<br>
                                    <br>
                                    UMR NO : {{ $ip_service_billing->patient->registration_no }}<br />
                                    <br />
                                    Father Name: {{ $ip_service_billing->patient->father_name }}
                                </font>
                            </td>
                            <td height="47" width="46%">
                                <font size="2" face="Arial, Helvetica, sans-serif"><br>
                                    Bill Dt
                                    &nbsp;&nbsp;&nbsp;:{{ date('d-m-Y h:i:sa', strtotime($ip_service_billing->created_at)) }}
                                    <br>
                                    <br>
                                    Age/Sex :
                                    <?php echo date('Y') - date('Y', strtotime($ip_service_billing->patient->dob)); ?>Y(s)/{{ $ip_service_billing->patient->gender->name }}<br>
                                    <br>
                                    Phone &nbsp;&nbsp;&nbsp;&nbsp;: {{ $ip_service_billing->patient->mobile }}<br />
                                    <br />
                                    Address: {{ $ip_service_billing->patient->address }}
                                </font>
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            <td colspan="2" height="17">&nbsp;&nbsp;&nbsp;&nbsp;<font size="2"
                ...
                <font face="Arial, Helvetica, sans-serif" size="2">
                    Consultant : {{ strtoupper($ip_service_billing->ipd->patient_visit->unit->name) }}
                </font>
            </td>
        </tr>
        <tr>
            <td colspan="2" height="47">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="99">
                    ...
                    @foreach ($ip_service_billing->billing_items as $ip_service_billing_item)
                        <tr>
                            ...
                            <td height="5" width="11%">
                                <div align="center">
                                    <font size="2" face="Arial, Helvetica, sans-serif">
                                        {{ $ip_service_billing_item->quantity }}</font>
                                </div>
                            </td>
                            <td height="5" width="14%">
                                <div align="center">
                                    <font size="2" face="Arial, Helvetica, sans-serif">
                                        {{ $ip_service_billing_item->unit_service_price }}</font>
                                </div>
                            </td>
                            <td height="5" width="15%">
                                <div align="center">
                                    <font size="2" face="Arial, Helvetica, sans-serif">
                                        {{ $ip_service_billing_item->total }}
                                    </font>
                                </div>
                            </td>
                        </tr>
        ...
        @if ($ip_service_billing->serviceDue != null)
            <tr>
                <td width="42%">&nbsp;</td>
                <td width="29%">
                ...
                <td width="15%">
                    <div align="center">
                        <font size="2" face="Arial, Helvetica, sans-serif">
                            {{ $ip_service_billing->serviceDue->paid_amount }}</font>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td width="15%">
                    <div align="center">
                        <font size="2" face="Arial, Helvetica, sans-serif">
                            {{ $ip_service_billing->serviceDue->due_amount }}</font>
                    </div>
                </td>
            </tr>
        @else
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            ...
            <td width="24%" height="31">
                <font size="2" face="Arial, Helvetica, sans-serif">:
                    &nbsp;&nbsp;&nbsp;{{ date('d-m-Y h:i:s A', strtotime($ip_service_billing->created_at)) }} </font>
            </td>
        ...
        <tr>
            ...
            <td width="38%" height="28">
                <font face="Arial, Helvetica, sans-serif" size="2">:
                    &nbsp;&nbsp;&nbsp;{{ $ip_service_billing->created_by->name }}</font>
            </td>
        ...
        <tr>
            ...
            <td width="8%" height="2">
                <font size="2" face="Arial, Helvetica, sans-serif">:{{ $ip_service_billing->code }}</font>
            </td>
        ...
        <tr>
            <td colspan="2">
                ...
                echo '<img src="data:image/png;base64,' . \Milon\Barcode\DNS1D::getBarcodePNG($ip_service_billing->patient->registration_no, 'C39', 1.5, 20) . '" alt="barcode"   />';
            ...
            <td colspan="2">
                <font face="Arial, Helvetica, sans-serif" size="2"></font>
                <font face="Arial, Helvetica, sans-serif" size="2"><?php
                echo '<img src="data:image/png;base64,' . \Milon\Barcode\DNS1D::getBarcodePNG($ip_service_billing->code, 'C39', 1.5, 20) . '" alt="barcode"   />';
