<div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto" data-toggle="tooltip" data-placement="top" title="ALT+C">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add" tabindex="1"><i
                            class="fa fa-plus"></i> Add Blocks</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                        ...
                        <tbody>
                            @foreach ($blocks as $block)
                                <tr>
                                    ...
                                    <td>{{ $block->state->country->name }}</td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button wire:click="edit({{ $block->id }})" class="dropdown-item"
                                                    href="#" data-toggle="modal" data-target="#edit"><i
                                                        class="fa fa-pencil m-r-5"></i> Edit
                                                    {{ $block->id }}</button>
                                                <button wire:click="delete({{ $block->id }})" class="dropdown-item"
    ...
    <!-- /Page Content -->
    @include('livewire.address-master.block-modal')
    @push('page-script')
        <script>
