<div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table data-order='[[1, "desc" ]]' class="datatable table table-stripped mb-0">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Created At</th>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button wire:click="edit({{ $country->id }})" class="dropdown-item"
                                                    href="#" data-toggle="modal" data-target="#edit"><i
                                                        class="fa fa-pencil m-r-5"></i> Edit</button>
                                                <button wire:click="delete({{ $country->id }})" class="dropdown-item"
    ...
    <!-- /Page Content -->
    @include('livewire.address-master.country-modal')
    @push('page-script')
        <script>
