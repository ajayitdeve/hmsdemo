                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" wire:model.live="rawage"
                                                min="0" max="200" wire:change.live='changeRwaAge'>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" wire:model="age" max="99"
                                                disabled tabindex="-1">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" wire:model="bloodgroup_id">
                                                ...
                                                @foreach ($bloodgroups as $bloodgroup)
                                                    <option value="{{ $bloodgroup->id }}">{{ $bloodgroup->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('bloodgroup_id')
                                    ...
                                    @if ($id_type_id != null)
                                        <div class="col-sm-6 col-md-3 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text"
                                                    wire:model="identification_no" maxlength="20" required>
                                ...
                                <div class="row mb-0 pb-0">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>HB%</label>
                                            <input type="text" class="form-control" wire:model="hb">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="ipd_id"
                                                data-placeholder="Select IPD" wire:model="ipd_id">
                                                <option value=""></option>
                                                @foreach ($ipds as $ipd)
                                                    <option value="{{ $ipd->id }}">
                                                        {{ $ipd->ipdcode }}</option>
