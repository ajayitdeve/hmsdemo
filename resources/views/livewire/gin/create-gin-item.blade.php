        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">Status: @if ($gin->status == 0)
                            Not Approved
                        @else
                            Approved
                        @endif
            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent='save'>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="row ">
                                <label class="col-md-4">Batch No {{ $batch_no }}<span
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="{{ route('admin.gin.print', $gin->id) }}" class="btn btn-info">Print GIN</a>
                        </div>
                    </div>
