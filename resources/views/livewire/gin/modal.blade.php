            ...
            <div class="modal-body">
                <form wire:submit.prevent='save'>
                    ...
                    @if ($mrq_id > 0)
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>From </label>
                                    <input type="text" class="form-control" readonly wire:model="stock_point_from">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>To </label>
                                    <input type="text" class="form-control" readonly wire:model="stock_point_to">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <br />
                                    <button
                                        class="brn btn-{{ $mrq_info->status == 0 ? 'danger' : 'success' }}">{{ $mrq_info->status == 0 ? 'Pending' : 'Approved' }}
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    @if ($currentGins != null)
                        ...
                        <div class="card p-0 m-0">
                            <div class="card-header p0 m-0">
                                <p>Existing GIN Items</p>
                            </div>
                            <div class="card-body p-0 m-0">
                                <table class="table table-bordered p-0 m-0">
                                    <thead>
