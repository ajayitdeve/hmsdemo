     ...
     <div class="modal-dialog modal-dialog-centered modal-md" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title">Add Good Receipt Notes</h5>
                 ...
                 <form wire:submit.prevent='save'>
                     <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select wire:model='vendor_id' class="form-control" wire:change="vendorChanged">
                            ...
                            <div class="form-group">
                                ...
                                <select wire:model='purchase_order_id' class="form-control" >
                                    ...
                                    @foreach ($purchaseOrders as $purchaseOrder)
                                        <option value="{{ $purchaseOrder->id }}">{{ $purchaseOrder->code }}
                                        </option>
                                    @endforeach
                                </select>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  wire:model='invoice_value' class="form-control" placeholder="">
