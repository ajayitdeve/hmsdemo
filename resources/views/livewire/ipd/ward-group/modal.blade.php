                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Add Ward Group</h5>
                        ...
                        <div class="form-group">
                            ...
                            @error('ward_tariff_id') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form wire:submit.prevent='update'>
                                ...
                                <div class="form-group">
                                    <label>Tariff Applicable{{$ward_tariff_id}}</label>
                                        <select class="form-control" wire:model="ward_tariff_id">
                                            <option value=""> Select Tariff</option>
                                            @foreach($wardTariffs as $wardTariff)
                                            <option value="{{$wardTariff->id}}" {{$wardTariff->id==$ward_tariff_id?'selected':null}}>{{$wardTariff->name}}</option>
                                            @endforeach
                                        </select>
                                    @error('ward_tariff_id') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
