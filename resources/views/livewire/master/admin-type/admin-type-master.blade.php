<div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto" data-toggle="tooltip" data-placement="top" title="ALT+C">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add" tabindex="1"><i
                            class="fa fa-plus"></i> Add Admission Type</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button wire:click="edit({{ $admin_type->id }})" class="dropdown-item"
                                                    href="#" data-toggle="modal" data-target="#edit"><i
                                                        class="fa fa-pencil m-r-5"></i> Edit
                                                </button>
                                                <button wire:click="delete({{ $admin_type->id }})" class="dropdown-item"
    ...
    <!-- /Page Content -->
    @include('livewire.master.admin-type.modal')
