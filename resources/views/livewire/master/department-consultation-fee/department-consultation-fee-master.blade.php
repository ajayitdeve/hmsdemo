<div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto" data-toggle="tooltip" data-placement="top" title="ALT+C">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add" tabindex="1"><i
                            class="fa fa-plus"></i> Add Department Consultation Fee</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <table data-order='[[3, "desc" ]]' class="datatable table table-stripped mb-0">
                        <thead>
                            <tr>
                                <th>S.No.</th>
                                <th>Department</th>
                        ...
                        <tbody>
                            @foreach ($departmentConsultationFees as $index => $departmentConsultationFee)
                                <tr>
                                    ...
                                    <td>{{ $departmentConsultationFee->created_at }}</td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button wire:click="edit({{ $departmentConsultationFee->id }})"
                                                    class="dropdown-item" href="#" data-toggle="modal"
                                                    data-target="#edit"><i class="fa fa-pencil m-r-5"></i> Edit</button>
                                                <button wire:click="delete({{ $departmentConsultationFee->id }})"
                                                    class="dropdown-item" href="#" data-toggle="modal"
    ...
    <!-- /Page Content -->
    @include('livewire.master.department-consultation-fee.modal')
