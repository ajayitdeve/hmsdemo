    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Department Consultation Fee</h5>
                            ...
                            <div class="form-group">
                                ...
                                <select wire:model='department_id' class="form-control">
                                    ...
                                    @foreach ($departments as $department)
                                        <option @if ($department->id == $department_id) selected @endif
...
<div wire:ignore.self class="modal custom-modal fade" id="edit" role="dialog">
    <div class="modal-dialog modal-dialog-centered " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Consultation Fee </h5>
