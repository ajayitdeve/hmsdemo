             ...
             <div class="modal-body">
                 <form wire:submit.prevent='save'>
                     <div class="form-group">
                         <label>Equipment Group<span class="text-danger">*</span></label>
                         <select class="form-control" wire:model='equipment_group_id'>
                             <option value="">Select Equipment Group</option>
                             @foreach ($equipment_groups as $equipment_group)
                                 <option value="{{ $equipment_group->id }}">{{ $equipment_group->name }}</option>
                             @endforeach
                         </select>
