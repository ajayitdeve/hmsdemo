             ...
             <div class="modal-body">
                 <form wire:submit.prevent='save'>
                     <div class="form-group">
                         ...
                         <input class="form-control" type="text" wire:model='code' placeholder="Location Code">
                         @error('code')
                     ...
                     <div class="form-group">
                         ...
                         <input class="form-control" type="text" wire:model='name' placeholder="Location name">
                         @error('name')
                             <span class="text-danger">{{ $message }}</span>
                         @enderror
                     </div>
