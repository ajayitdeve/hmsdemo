                        ...
                        <div class="modal-body">
                            <form wire:submit.prevent='save'>
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-8">{{$referral_type_id}}
                                    <select wire:model='referral_type_id' class="form-control">
                                    ...
                                    @error('referral_type_id') <span class="text-danger">{{ $message }}</span> @enderror
                                   </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-8">
                                    <input class="form-control" type="text" wire:model='alias' >
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-8">
                                    <input class="form-control" type="text" wire:model='ipdpercent' >
                                    @error('ipdpercent') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-8">
                                    <input class="form-control" type="text" wire:model='opdpercent' >
                                    @error('opdpercent') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                   ...
                                   <div class="col-md-8">
                                    <input class="form-control" type="text" wire:model='investigationpercent' >
                                    @error('investigationpercent') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
