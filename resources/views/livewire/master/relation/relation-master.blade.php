<div>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Relation</h3>
                    <ul class="breadcrumb">
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button wire:click="edit({{ $relation->id }})" class="dropdown-item"
                                                    href="#" data-toggle="modal" data-target="#edit"><i
                                                        class="fa fa-pencil m-r-5"></i> Edit</button>
                                                <button wire:click="delete({{ $relation->id }})" class="dropdown-item"
    ...
    <!-- /Page Content -->
    @include('livewire.master.relation.modal')
    @push('page-script')
        <script>
