    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h2>OPD Service Billing- Overall Discount</h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-2 border-top border-primary">
                        ...
                        <div class="col-md-3">
                            <div class="row pt-2">
                                <label class="col-md-6">Overall Discount<span class="text-danger">*</span></label>
                                <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            @if ($overallDiscount > 0)
                                <div class="row p-2 m-2 bg-info">
                                    <div class="col-md-12">
                                        <label class="col-md-4">Disc. Approved By <span
