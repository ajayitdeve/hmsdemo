        ...
        <form wire:submit.prevent='save'>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-9">
                            <h2>OPD Patient Medicine Sale</h2>
                        </div>
                        <div class="col-md-3">
                            <a href="{{ route('admin.osp-medicine-sale.sale') }}">Without UMR (Out Side Patient)</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="">Stock Point<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" wire:model="umr"
                                            wire:change="umrChanged" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row mt-2 border-top border-primary">
                        <div class="col-md-4">
                            <div class="row mt-2">
                                ...
                                <label class="col-md-6">Cash Amount Received <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-6">
