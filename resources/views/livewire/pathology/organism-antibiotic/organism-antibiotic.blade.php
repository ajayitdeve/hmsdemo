<div>
                        ...
                        <tbody>
                            @foreach ($antibiotics as $index => $antibiotic)
                                <tr>
                                    ...
                                    <td>{{ $antibiotic->service_group_id }}</td>
                                    <td>{{ $antibiotic->service_group_id }}</td>
                                    <td>{{ $antibiotic->service_id }}</td>
                                    <td>service Name</td>
                                    <td>{{ $antibiotic->format_id }}</td>
                                    <td>
                                    ...
                                    <td>{{ $antibiotic->sa_cd }}</td>
                                    <td>{{ $antibiotic->s2_cd }}</td>
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <button wire:click="deleteTitle({{ $antibiotic->id }})"
    ...
    <!-- /Page Content -->
    @include('livewire.pathology.organism-antibiotic.modal')
