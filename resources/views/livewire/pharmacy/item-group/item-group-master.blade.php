<div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add"><i
                            class="fa fa-plus"></i> Add Item Group</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->
                        ...
                        <tbody>
                            @foreach ($itemgroups as $itemgroup)
                                <tr>
                                    ...
                                    <td>{{ $itemgroup->type->name }}</td>
                                    <td>{{ $itemgroup->costcenter->code }}</td>
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown"
                                                aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <button wire:click="edit({{ $itemgroup->id }})" class="dropdown-item"
                                                    href="#" data-toggle="modal" data-target="#edit"><i
                                                        class="fa fa-pencil m-r-5"></i> Edit</button>
                                                <button wire:click="delete({{ $itemgroup->id }})" class="dropdown-item"
    ...
    <!-- /Page Content -->
    @include('livewire.pharmacy.item-group.modal')
