     ...
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title">Add Teriff</h5>
             ...
             <div class="modal-body">
                 <form wire:submit.prevent='save'>
                     <div class="row">
                         ...
                         <div class="col-md-6">
                             <div class=" form-group">
                                 <label class=""><strong>Is Never Expired</strong></label>
                                 <input type="checkbox" class="form-control" wire:model='isneverexpired' />
                                 @error('isneverexpired')
                                     <span class="text-danger">{{ $message }}</span>
                                 @enderror
                             </div>
                         </div>
 ...
 <div wire:ignore.self class="modal custom-modal fade" id="edit" role="dialog">
     <div class="modal-dialog modal-dialog-centered" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title">Edit Teriff </h5>
                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                     <span aria-hidden="true">&times;</span>
                 </button>
             </div>
