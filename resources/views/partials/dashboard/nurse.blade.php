            ...
            <div class="card dash-widget" style="background-color: #2B77B0;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.nurse.nurse-station') }}" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\Ipd\NurseStation::count() }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #A6A63B;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.nurse.patient-list') }}" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>
                                    {{ App\Models\Ipd\Ipd::whereHas('room', function ($query) {
                                        $query->when(session()->has('nurse_station_id'), function ($q1) {
                                            $q1->where('nurse_station_id', session()->get('nurse_station_id'));
                                        });
                                    })->count() }}
                                </h3>
                                <span>Patients</span>
                ...
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.nurse.drug-management.drug-indent') }}"
                            ...
                            <div class="dash-widget-info">
                                <h3>
                                    {{ \App\Models\IpPharmacyIndent::when(session()->has('nurse_station_id'), function ($query) {
                                        $query->where('nurse_station_id', session('nurse_station_id'));
                                    })->count() }}
                                </h3>
                ...
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.nurse.service-lab-indent.lab-indent') }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3> {{ \App\Models\IpLabIndent::when(session()->has('nurse_station_id'), function ($query) {
                                    $query->where('nurse_station_id', session('nurse_station_id'));
                                })->count() }}
                                </h3>
                                <span>Lab Indent</span>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                                ...
                                @foreach (\App\Models\BloodRequisitionRequest::latest()->take(10)->get() as $blood_requisition_request)
                                    <tr>
                                        ...
                                        @if ($blood_requisition_request->type == 'outside-patient')
                                            <td>
                                                {{ $blood_requisition_request?->out_side_patient?->registration_no }}
                                            </td>
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.blood-requisition-request') }}">View all</a>
                </div>
            </div>
        </div>
