            ...
            <div class="card dash-widget" style="background-color: #2B77B0;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.mrq.list-store-mrq') }}" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\Mrq::count() }}</h3>
                                <span>MRQ</span>
                            </div>
                        </a>
                    </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #A6A63B;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.pharmacy.pharmacy-internal-transfer-gin') }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\Gin::count() }}</h3>
                                <span>GIN</span>
                            </div>
                        </a>
                    </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #C60196;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.pharmacy.scrap.list-scrap') }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\Scrap::count() }}</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="javascript:void(0);" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3> {{ \App\Models\OpdMedicineTransaction::sum('taxable_amount') }}
                                </h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #6C330F;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.pharmacy.pharmacy-cancle-receipt') }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3> {{ \App\Models\OpdMedicineReceipt::where('is_cancled', 1)->count() }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #FFC107;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.pharmacy.issues.ip-pharmacy-billing') }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3> {{ \App\Models\IpPharmacyIndentBilling::count() }}</h3>
    ...
    <div class="row">
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                <div class="card-header">
                    <h3 class="card-title mb-0">Recent IP Billing</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table custom-table mb-0">
                            ...
                            <tbody>
                                @foreach (App\Models\IpPharmacyIndentBilling::latest()->take(10)->get() as $ip_pharmacy_billing)
                                    <tr>
        ...
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table custom-table mb-0">
                            ...
                            <tbody>
                                @foreach (\App\Models\Gin::latest()->take(10)->get() as $gin)
                                    <tr>
                                        ...
                                        <td>
                                            <a target="_blank" style="display:inline;float:right"
                                                ...
                                                href="{{ route('admin.gin.create-gin-items', $gin->id) }}">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.pharmacy.pharmacy-internal-transfer-gin') }}">View all GIN</a>
                </div>
            </div>
        </div>
    </div>
