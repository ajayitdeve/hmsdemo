            ...
            <div class="card dash-widget" style="background-color: #2B77B0;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.opd-coordinator.assign-doctor', ['status' => 'not_assign']) }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\PatientVisit::whereNull('doctor_id')->count() }}</h3>
                                <span>Unassign Doctor</span>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #A6A63B;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.opd-coordinator.assign-doctor', ['status' => 'assign']) }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\PatientVisit::whereNotNull('doctor_id')->count() }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #C60196;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.refer-patient') }}" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3>{{ App\Models\Refer::count() }}</h3>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #EC851E;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.patient.list') }}" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
                                <h3> {{ \App\Models\Patient::count() }}
                                </h3>
                                <span>Patients</span>
                            </div>
                        </a>
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #6C330F;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.patient.consultation-list') }}"
                            style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
        ...
        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
            <div class="card dash-widget" style="background-color: #FFC107;">
                <div class="card-body">
                    ...
                    <div class="dash-widget-info">
                        <a href="{{ route('admin.all-opd-bill') }}" style="text-decoration: none;color:white;">
                            <div class="dash-widget-info">
        ...
        <div class="col-md-6 d-flex">
            <div class="card card-table flex-fill">
                <div class="card-header">
                    <h3 class="card-title mb-0">Recent Not Assign Doctor</h3>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <table class="table custom-table mb-0">
                            ...
                            <tbody>
                                @foreach (App\Models\PatientVisit::whereNull('doctor_id')->latest()->take(10)->get() as $patientvisit)
                                    <tr>
